...
- **APRS authentication**: HMAC-SHA256 with 12-character Base64 truncation (~72 bits of security). Time-based with ±5 minute window for clock skew tolerance. Auth key derived via SHA-256 hash of the station password.
